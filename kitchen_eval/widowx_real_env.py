...
TARGET_POINT = np.array([0.18887618, 0.00295324, 0.03638198])
...
start_transforms = dict(
    ...
    toykitchen1_take_carrot_plate = [traj_group_take_carrot_plate, (0, 5)],
    toykitchen1_pot_in_sink= [traj_group_pot_sink, (0, 5)],
    toykitchen1_put_sushi_on_plate= [traj_group_put_sushi_on_plate, (0, 5)],
